...
// 75 byte paket: 75 - L2(18) - IP(20) - UDP(8) = 29 byte payload
// Payload = SEQ(8) + PRBS(21) minimum
#define MIN_IMIX_PAYLOAD_VLAN    (75 - ETH_HDR_SIZE - VLAN_HDR_SIZE - IP_HDR_SIZE - UDP_HDR_SIZE)
#define MIN_IMIX_PAYLOAD_NO_VLAN (75 - ETH_HDR_SIZE - IP_HDR_SIZE - UDP_HDR_SIZE)
#define MIN_IMIX_PRBS_BYTES      (MIN_IMIX_PAYLOAD_VLAN - SEQ_BYTES)  // 21 bytes
